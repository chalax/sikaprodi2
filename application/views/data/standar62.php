...
<table class="table table-bordered">
	...
	<tbody>
		<tr>
			...
			<td><span id="st6f21c1"></span> </td>
			<td><span id="st6f21c2"></span> </td>
			<td><span id="st6f21c3"></span> </td>
	...
	<tbody>
		<tr>
			...
			<td><span id="st6f22c1"></span> </td>
			<td><span id="st6f22c2"></span> </td>
			<td><span id="st6f22c3"></span> </td>
...
function loadjumlah621(){
	$.ajax({
          ...
          .done(function( msg ) {
           	...
           	$('#st6f21c1').text(msg[0].jumlahdanath2);
			$('#st6f21c2').text(msg[0].jumlahdanath1);
			$('#st6f21c3').text(msg[0].jumlahdanath0);
...
function loadjumlah622(){
	$.ajax({
          ...
          .done(function( msg ) {
           	...
           	$('#st6f22c1').text(msg[0].jumlahdanath2);
			$('#st6f22c2').text(msg[0].jumlahdanath1);
			$('#st6f22c3').text(msg[0].jumlahdanath0);
