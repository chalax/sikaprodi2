...
<table class="table table-bordered">
	...
	<tbody>
		<tr>
			...
			<td><input type="text" class="form-control" id="st5f7c1"></td>
			<td><input type="text" class="form-control" id="st5f7c2"> </td>
			<td>
				
								<input type="hidden" id="st5f7c3">
				<span class="btn btn-success fileinput-button">
			        <i id="st5f7btnupload" class="glyphicon glyphicon-open"></i>
			        
			        <!-- The file input field used as target for the file upload widget -->
			        <input id="st5f7upload" type="file" name="files[]" accept="application/pdf">
			    </span>

			</td>
			<td><button id="btnsimpan57" type="button" class="btn btn-info"><span class="glyphicon glyphicon-plus"></span></button></td>
		</tr>
	</tbody>
</table>
