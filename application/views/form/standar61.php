...
<table class="table table-bordered">
	...
	<tbody>
		<tr>
			...
			<td><input type="text" class="form-control" id="st6f1c1"></td>
			<td><input type="text" class="form-control" id="st6f1c2"> </td>
			<td><input type="number" value="0" min="0" class="form-control" id="st6f1c3"> </td>
			<td><input type="number" value="0" min="0" class="form-control" id="st6f1c4"> </td>
			<td><input type="number" value="0" min="0" class="form-control" id="st6f1c5"> </td>
			
			<td><button id="btnsimpan61" type="button" class="btn btn-info"><span class="glyphicon glyphicon-plus"></span></button></td>
		</tr>
	</tbody>
