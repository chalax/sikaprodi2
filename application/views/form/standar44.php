...
<table class="table table-bordered">
	...
	<tbody>
		<tr>
			<td></td>
			<td><input type="text" id="st4f41c1" class="form-control"></td>
			<td><input type="text" id="st4f41c2" class="form-control"></td>
			<td></td>
			<td></td>
			<td></td>
			<td></td>
			<td></td>
			<td><button class="btn btn-info" type="button" id="btntambahdata44"><span class="glyphicon glyphicon-plus"></span></button></td>
...
<table class="table table-bordered">
	...
	<tbody id="dataajardosentetapsemester2"></tbody>
	<tbody>
		<tr>
			<td></td>
			<td><input type="text" id="st4f42c1" class="form-control"></td>
			<td><input type="text" id="st4f42c2" class="form-control"></td>
			<td></td>
			<td></td>
			<td></td>
			<td></td>
			<td></td>
			<td><button class="btn btn-info" type="button" id="btntambahdata45"><span class="glyphicon glyphicon-plus"></span></button></td>
	          ...
	          .done(function( msg ) {
	            	$('#datatabel44modal').html('');
		          	...
		          	for (var i = msg.length - 1; i >= 0; i--) {
		          		$('#datatabel44modal').append('<tr> <td>'+msg[i].kode_matakuliah+'</td> <td>'+msg[i].nama_matakuliah+'</td> <td>'+msg[i].jumlah_kelas+'</td> <td>'+msg[i].jumlah_pertemuan_direncanakan+'</td> <td>'+msg[i].jumlah_pertemuan_terlaksana+'</td> <td> <button onClick="hapusdetail44('+msg[i].id_detail_data_ajar_dosen_tetap_bidang_sesuai_ps+','+id+')" type="button" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span></button> </td> </tr>');
