...
<table class="table table-bordered">
	...
	<tbody>
		<tr>
			<td></td>
			<td><input type="text" class="form-control" id="st7f3c1"> </td>
			<td><input type="text" class="form-control" id="st7f3c2"> </td>
			<td><button class="btn btn-info" id="btnsimpan73"><span class="glyphicon glyphicon-plus"></span></button></td>
		</tr>
