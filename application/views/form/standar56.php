...
<table class="table table-bordered">
	...
	<tbody>
		<tr>
			<td>
				<select id="st5f6c1" class="form-control">
			...
			<td><input type="text" class="form-control" id="st5f6c2"></td>
			<td><input type="number" min="0" value="0" class="form-control" id="st5f6c3"> </td>
			<td>
				
								<input type="hidden" id="st5f6c4">
				<span class="btn btn-success fileinput-button">
			        <i id="st5f6btnupload" class="glyphicon glyphicon-open"></i>
			        
			        <!-- The file input field used as target for the file upload widget -->
			        <input id="st5f6upload" type="file" name="files[]" accept="application/pdf">
			    </span>

			</td>
			<td><button id="btnsimpan56" type="button" class="btn btn-info"><span class="glyphicon glyphicon-plus"></span></button></td>
		</tr>
	</tbody>
</table>
